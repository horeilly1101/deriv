...
- I built a really messy frontend to interact with the API. Feel free to email me if you want see it. Also,
it should be quite easy to convert the entirety of the API into a Java package that has static methods with
the same functionality. If you really want that, I can put it together.