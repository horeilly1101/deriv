...
//      List<Expression> simp1 = withoutNesting(factors);
//      if (simp1.size() < 2) {
//        return simp1;
//      }
//
//      List<Expression> simp2 = simplifyConstants(simp1);
//      if (simp2.size() < 2) {
//        return simp2;
//      }
//
//      return simplifyFactors(simp2);
//    }
//
//    /**
...
//          // checked cast
//          constants *= ((Expression.Constant) factor).val;
//        } else {
...
//      List<Expression> simp1 = withoutNesting(terms);
//      if (simp1.size() < 2) {
//        return simp1;
//      }
//
